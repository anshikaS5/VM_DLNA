...
public class CustomListItem {
    ...
    private String menifactureDetails;
    ...
    public String getMenifactureDetails() {
        return menifactureDetails;
    }

    public void setMenifactureDetails(String menifactureDetails) {
        this.menifactureDetails = menifactureDetails;
    }
}
